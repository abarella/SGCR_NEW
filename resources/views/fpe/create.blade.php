...
@section('title', 'Nova Folha de Prod.-Embalado')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Nova Folha de Prod.-Embalado</h3>
                ...
                <div class="card-body">
                    <form action="{{ route('fpe.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('data_embalagem') is-invalid @enderror" 
                                           id="data_embalagem" name="data_embalagem" value="{{ old('data_embalagem') }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('produto') is-invalid @enderror" 
                                           id="produto" name="produto" value="{{ old('produto') }}" required>
                                    @error('produto')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <a href="{{ route('fpe.index') }}" class="btn btn-secondary">
