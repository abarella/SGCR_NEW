...
@section('title', 'Nova Transferência de Material')

@section('content')
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Nova Transferência de Material</h3>
    ...
    <div class="card-body">
        <form action="{{ route('trf-tm.store') }}" method="POST">
            @csrf
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control @error('data_transferencia') is-invalid @enderror" 
                               id="data_transferencia" name="data_transferencia" value="{{ old('data_transferencia') }}" required>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('origem') is-invalid @enderror" 
                               id="origem" name="origem" value="{{ old('origem') }}" required>
                        @error('origem')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('responsavel') is-invalid @enderror" id="responsavel" name="responsavel">
                            ...
                            @foreach(\App\Models\User::all() as $user)
                                <option value="{{ $user->id }}" {{ old('responsavel') == $user->id ? 'selected' : '' }}>
                                    {{ $user->name }}
                                </option>
                            @endforeach
                        </select>
            ...
            <div class="form-group">
                ...
                <a href="{{ route('trf-tm.index') }}" class="btn btn-secondary">
